 ...
 * @author
 */
public class BairroDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<Bairro> list_atual;
    List<Municipio> objs;
    BairroDAOImplement daoObject;

    public BairroDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getBairroDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, Bairro obj) {
        model.addRow(new Object[]{
            obj.getNome(),
            obj.getMunicipio().getNome()+" - "+obj.getMunicipio().getProvincia().getNome()
        });
    }

    public void preecherCombo() {
        try {
            objs = pai.control.getMunicipioDAO().findAll();
            if (objs.size() == 0) {
                msg = new Toast("Província deve ser inserida antes.", 2000);
                msg.showToast();
                this.dispose();
            } else {
                for (Municipio obj : objs) {
                    combo.addItem(obj.getNome()+" - "+obj.getProvincia().getNome());
                }
            }
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<Bairro> list = daoObject.findAll();
            list_atual = list;
            for (Bairro obj : list) {
    ...
    public void updateJTableBusca(List<Bairro> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (Bairro obj : list) {
            addRowTableModel(model, obj);
    ...
    public void editar(Bairro obj) {
        if (!nome.getText().equals("")) {
            try {
                ...
                obj.setMunicipio(objs.get(combo.getSelectedIndex()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            Bairro obj = new Bairro(objs.get(combo.getSelectedIndex()), nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        Bairro obj = list_atual.get(tabela.getSelectedRow());
        nome.setText(obj.getNome());
        combo.setSelectedItem(obj.getMunicipio().getNome());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    Bairro obj = list_atual.get(rows[0]);
                    editar(obj);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BairroDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BairroDialog dialog = new BairroDialog(new javax.swing.JFrame(), true);
