...
public class CategoriaDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<Categoria> list_atual;
    CategoriaDAOImplement daoObject;

    public CategoriaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getCategoriaDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, Categoria obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<Categoria> list = daoObject.findAll();
            list_atual = list;
    ...
    public void updateJTableBusca(List<Categoria> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (Categoria obj : list) {
            addRowTableModel(model, obj);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            Categoria obj = new Categoria(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void busca_nomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busca_nomeKeyPressed
        ...
        updateJTable();
        boolean flag = false;
        for (Categoria list1 : list_atual) {
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        Categoria obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    Categoria obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
