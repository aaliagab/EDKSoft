 ...
 * @author
 */
public class TipoInscricaoDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<TipoInscricao> list_atual;
    TipoInscricaoDAOImplement daoObject;

    public TipoInscricaoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getTipoInscricaoDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, TipoInscricao obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<TipoInscricao> list = daoObject.findAll();
            list_atual = list;
            for (TipoInscricao obj : list) {
    ...
    public void updateJTableBusca(List<TipoInscricao> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (TipoInscricao obj : list) {
            addRowTableModel(model, obj);
    ...
    public void editar(TipoInscricao obj) {
    ...
    private void initComponents() {
        ...
        setTitle("GERENCIAR TIPOS DE INSCRIÇÃO");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            TipoInscricao obj = new TipoInscricao(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void busca_nomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busca_nomeKeyPressed
        List<TipoInscricao> list = new ArrayList<>();
        updateJTable();
        boolean flag = false;
        for (TipoInscricao list1 : list_atual) {
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        TipoInscricao obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    TipoInscricao obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoInscricaoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipoInscricaoDialog dialog = new TipoInscricaoDialog(new javax.swing.JFrame(), true);
