 ...
 * @author
 */
public class TipoTransporteDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<TipoTransporte> list_atual;
    TipoTransporteDAOImplement daoObject;

    public TipoTransporteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getTipoTransporteDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, TipoTransporte obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<TipoTransporte> list = daoObject.findAll();
            list_atual = list;
            for (TipoTransporte obj : list) {
    ...
    public void updateJTableBusca(List<TipoTransporte> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (TipoTransporte obj : list) {
            addRowTableModel(model, obj);
    ...
    public void editar(TipoTransporte obj) {
    ...
    private void initComponents() {
        ...
        setTitle("GERENCIAR TIPOS DE TRANSPORTE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            TipoTransporte obj = new TipoTransporte(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void busca_nomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busca_nomeKeyPressed
        ...
        updateJTable();
        boolean flag = false;
        for (TipoTransporte list1 : list_atual) {
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        TipoTransporte obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    TipoTransporte obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoTransporteDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipoTransporteDialog dialog = new TipoTransporteDialog(new javax.swing.JFrame(), true);
