 ...
 * @author
 */
public class CargoDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<Cargo> list_atual;
    CargoDAOImplement daoObject;

    public CargoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getCargoDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, Cargo obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<Cargo> list = daoObject.findAll();
            list_atual = list;
            for (Cargo obj : list) {
    ...
    public void updateJTableBusca(List<Cargo> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (Cargo obj : list) {
            addRowTableModel(model, obj);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            Cargo obj = new Cargo(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        Cargo obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    Cargo obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CargoDialog dialog = new CargoDialog(new javax.swing.JFrame(), true);
